...
(function() {
	...
	(e = (function() {
		function e(e, t) {
			...
			(this.context =
				t != null ? t : this), (this.unique = this._genKey());
		}
		return (e.prototype.hasNext = function() {
			...
			if (
				...
				throw new Error("Missing clientId or accessToken.");
			return this.options.before != null &&
				typeof this.options.before == "function" &&
				this.options.before.call(this), typeof document !=
				"undefined" &&
				document !== null &&
				(
			...
			if (typeof e != "object") {
				if (
					...
					return this.options.error.call(
						this,
						"Invalid JSON data"
					), !1;
			...
			this.options.success != null &&
				...
				this.options.success.call(this, e), (this.context.nextUrl =
				""), e.pagination != null &&
				(this.context.nextUrl = e.pagination.next_url);
			if (this.options.sortBy !== "none") {
				this.options.sortBy === "random"
					? (M = ["", "random"])
					: (M = this.options.sortBy.split("-")), (O =
					M[0] === "least" ? !0 : !1);
				switch (M[1]) {
					case "random":
			...
			if (
				...
				(m = e.data), (A = parseInt(this.options.limit, 10)), this
					.options.limit != null &&
					m.length > A &&
					(m = m.slice(
						0,
						A
					)), (u = document.createDocumentFragment()), this.options
					.filter != null &&
				...
				if (
					...
					for (c = 0, N = m.length; c < N; c++) {
						...
						(E = p.width), (y = p.height), (b = "square"), E > y &&
							(b = "landscape"), E < y && (b = "portrait"), (v =
							p.url), (l =
							window.location.protocol.indexOf("http") >= 0), l &&
					...
					for (T = 0, k = m.length; T < k; T++) {
						(h = m[T]), (g = document.createElement("img")), (p =
							h.images[this.options.resolution]);
						if (typeof p != "object")
							throw (
								(o =
									"No image found for resolution: " +
				...
				(_ = this.options.target), typeof _ == "string" &&
				...
				), (S = "instafeedCache" + this.unique), (window[S] = void 0);
				try {
					delete window[S];
				} catch (P) {
					s = P;
			...
			return this.options.after != null &&
				typeof this.options.after == "function" &&
				this.options.after.call(this), !0;
			...
			return (r = function(e, r) {
				var i, s;
				return (i = this._getObjectProperty(
					e,
					t
				)), (s = this._getObjectProperty(r, t)), n
					? i > s ? 1 : -1
					: i < s ? 1 : -1;
